...
(function () {
	...
	DCPU16.NE_LEM1802 = function (dcpu) {
		...
		this.default_font = [0xB79E, 0x388E, 0x722C, 0x75F4, 0x19BB, 0x7F8F, 0x85F9, 0xB158, 0x242E, 0x2400, 0x082A, 0x0800, 0x0008, 0x0000, 0x0808, 0x0808,
		...
		this.drawScreen = function (canvas, width, height) {
			...
			for (i = 0; i < 0x180; i++ ) {
				...
				if (this.font) {
					...
					char = (this.default_font[((val & 0x7f) << 1)] << 16) | (this.default_font[((val & 0x7f) << 1) + 1]);
				}
