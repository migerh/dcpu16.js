    ...
    parse: function(input, startRule) {
      ...
      function parse_stmt() {
        ...
        if (result41 !== null) {
          ...
          var result42 = result62 !== null ? result62 : '';
          if (result42 !== null) {
            var result43 = parse_ws();
            if (result43 !== null) {
              var result44 = parse_label();
              if (result44 !== null) {
                      ...
                      if (result48 !== null) {
                        ...
                        if (result49 !== null) {
                          ...
                          if (result50 !== null) {
                            ...
                            if (result51 !== null) {
                              var result61 = parse_nl();
                              var result52 = result61 !== null ? result61 : '';
                              if (result52 !== null) {
                                if (input.substr(pos, 1) === "{") {
                                  var result53 = "{";
                                  pos += 1;
                                ...
                                if (result53 !== null) {
                                  ...
                                  if (result54 !== null) {
                                    var result60 = parse_nl();
                                    var result55 = result60 !== null ? result60 : '';
                                    if (result55 !== null) {
                                      var result56 = parse_statements();
                                      if (result56 !== null) {
                                        ...
                                        if (result57 !== null) {
                                          ...
                                          if (result58 !== null) {
                                            ...
                                            if (result59 !== null) {
                                              var result39 = [result41, result42, result43, result44, result45, result46, result47, result48, result49, result50, result51, result52, result53, result54, result55, result56, result57, result58, result59];
                                            } else {
                                              var result39 = null;
                                              pos = savedPos10;
                                            }
        ...
        var result40 = result39 !== null
          ? (function(name, params, code) {
              ...
              })(result39[3], result39[7], result39[15])
          : null;
        if (result40 !== null) {
        ...
        if (result38 !== null) {
          ...
          if (result27 !== null) {
            ...
            if (result22 !== null) {
              var result23 = parse_directive();
              if (result23 !== null) {
                var result24 = parse_ws();
                if (result24 !== null) {
                  var result25 = parse_paramlist();
                  if (result25 !== null) {
                  ...
                  if (result18 !== null) {
                    ...
                    if (result19 !== null) {
                      ...
                      if (result20 !== null) {
                        ...
                        if (result21 !== null) {
                          var result11 = [result13, result14, result15, result16, result17, result18, result19, result20, result21];
                        } else {
                          var result11 = null;
                          pos = savedPos4;
                        }
      ...
      function parse_additive() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_multiplicative();
        if (result3 !== null) {
